...
optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=GestionPlazasVacantesDB_Demo;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=true");
